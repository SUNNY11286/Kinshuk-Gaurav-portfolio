! function(e) {
    ...
    if (e(window).on("load", (function() {
            ...
            return this.each((function() {
                ...
                e(i).each((function() {
                    e(this).on("click", (function(t) {
                        var n, i;
                        t.preventDefault(), n = e(this).parent(), (i = n.children("ul")).length > 0 && (n.toggleClass(a.subMenuParentToggle), i.slideToggle(a.toggleSpeed), i.toggleClass(a.subMenuToggleClass))
                    }))
        ...
        }, e(".th-menu-wrapper").thmobilemenu(), e(t = ".onepage-nav").length > 0 && e(t).each((function() {
            var t = e(this).find("a");
    ...
    var o = new Swiper(".testi-slider1", {
        ...
        r = new Swiper(".testi-thumb-slider1", {
            effect: "fade",
            autoHeight: !0
        });
    o.controller.control = r, r.controller.control = o, e.fn.activateSliderThumbs = function(t) {
        var a = e.extend({
            sliderTab: !1,
            tabButton: ".tab-btn"
        }, t);
    ...
    function f() {
        ...
        (function() {
            ...
            function n(n) {
                n = n.split(",");
                for (var i = 0; i < n.length; i++) t = u + " " + n[i], e(t).val() ? (e(t).removeClass("is-invalid"), a = !0) : (e(t).addClass("is-invalid"), a = !1)
            }
            n('[name="name"],[name="email"],[name="subject"],[name="number"],[name="message"]'), e(h).val() && e(h).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(h).removeClass("is-invalid"), a = !0) : (e(h).addClass("is-invalid"), a = !1);
            return a
        })() && jQuery.ajax({
            url: e(u).attr("action"),
            data: t,
            ...
            p.removeClass("error"), p.addClass("success"), p.text(t), e(u + ' input:not([type="submit"]),' + u + " textarea").val("")
        })).fail((function(e) {
    ...
    e(u).on("submit", (function(e) {
        e.preventDefault(), f()
    })), c = ".popup-search-box", l = ".searchClose", d = "show", e(".searchBoxToggler").on("click", (function(t) {
        t.preventDefault(), e(c).addClass(d)
    })), e(c).on("click", (function(t) {
        t.stopPropagation(), e(c).removeClass(d)
    })), e(c).find("form").on("click", (function(t) {
        t.stopPropagation(), e(c).addClass(d)
    })), e(l).on("click", (function(t) {
        t.preventDefault(), t.stopPropagation(), e(c).removeClass(d)
        ...
        e(this).each((function() {
            ...
            n = Math.floor(c.height() / 2), i = c.attr(t), s = c.attr(a), o = g(e(s).css("padding-top")), r = g(e(s).css("padding-bottom")), "top-half" === i ? (e(s).css("padding-bottom", r + n + "px"), c.css("margin-top", "-" + n + "px")) : "bottom-half" === i && (e(s).css("padding-top", o + n + "px"), c.css("margin-bottom", "-" + n + "px"))
        }))
    };
    e("[data-sec-pos]").length && e("[data-sec-pos]").imagesLoaded((function() {
        ...
        e(this).each((function() {
            ...
            var i = setInterval((function() {
                ...
                o < 10 && (o = "0" + o), r < 10 && (r = "0" + r), c < 10 && (c = "0" + c), l < 10 && (l = "0" + l), s < 0 ? (clearInterval(i), t.addClass("expired"), t.find(".message").css("display", "block")) : (n(".day").html(o), n(".hour").html(r), n(".minute").html(c), n(".seconds").html(l))
            }), 1e3)
        }))
    ...
    e.fn.inlineSvg = function() {
    ...
    })), e(".marquee_mode").length && e(".marquee_mode").marquee({
        speed: 100,
        gap: 0,
        delayBeforeStart: 0,
        direction: "left",
        ...
        pauseOnHover: !0,
        startVisible: !0
    }), e(".service1-tab-wrap li:first-child").addClass("active"), e(".service1-tab-content").hide(), e(".service1-tab-content:first").show(), e(".service1-tab-wrap li").mouseenter((function() {
        e(".service1-tab-wrap li").removeClass("active"), e(".service1-tab-content").hide();
    ...
    function w(e) {
        ...
        TweenMax.to(t, 1, {
            x: 50 * ((e.clientX - a.left) / t.offsetWidth - .5),
            y: 50 * ((e.clientY - a.top) / t.offsetHeight - .5),
            ease: Power4.easeOut
        })
    }
    y.forEach(e => {
        e.addEventListener("mousemove", w), e.addEventListener("mouseout", (function(e) {
